...
/**
 * Class Responsibility: Handles view logic and user interactions for FeeDiscountCategoryComponent.
 */
...
let AcademicYearIdSelected='';
    ...
    return this.apiurl.post<any>('Tbl_FeeDiscountCategory_CRUD_Operations', payload);
  }
  ...
  SubmitClass(){
    if(this.ClassForm.invalid){
      ...
      this.apiurl.post("Tbl_FeeDiscountCategory_CRUD_Operations", data).subscribe({
        next: (response: any) => {
  ...
  FetchSyllabusDetByID(SyllabusID: string, mode: 'view' | 'edit') {
    ...
    this.apiurl.post<any>("Tbl_FeeDiscountCategory_CRUD_Operations", data).subscribe(
      (response: any) => {
