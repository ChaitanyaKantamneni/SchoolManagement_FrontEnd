...
/**
 * Class Responsibility: Handles view logic and user interactions for ClassComponent.
 */
export class ClassComponent extends BasePermissionComponent {
  pageName = 'Class';
  ...
  FetchAcademicYearCount(isSearch: boolean) {
    ...
    return this.apiurl.post<any>('Tbl_Class_CRUD_Operations', payload);
  }
  ...
  FetchInitialData(extra: any = {}) {
    ...
    this.FetchAcademicYearCount(isSearch).subscribe({
      next: (countResp: any) => {
        ...
        this.apiurl.post<any>('Tbl_Class_CRUD_Operations', payload).subscribe({
          next: (response: any) => {
